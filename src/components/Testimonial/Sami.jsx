    ...
    <div className="flex flex-col gap-[50px] items-center md:flex-row md:items-end lg:gap-44 lg:items-center">
      ...
      <div className="flex flex-col sm:w-10/12">
        ...
        <Paragraph style="mb-9">
          “Develops data analysis and recommendation logic to derive insights from soil health data.”
        </Paragraph>
        <div className="flex flex-col font-body">
          <h5 className="text-primary-100 mb-2.5 font-medium">Abdul Sami</h5>
          <p className="text-black-300">22k-4354</p>
        </div>
      </div>
    </div>
  );
