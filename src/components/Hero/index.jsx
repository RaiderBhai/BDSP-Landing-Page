      ...
      <div className="flex flex-col gap-[44px] p-5 py-6  min-h-screen h-auto justify-center md:p-0 lg:px-10 lg:pt-10 lg:pb-20 lg:min-h-fit lg:items-center lg:flex-row lg:justify-between lg:gap-5 overflow-hidden">
        <motion.div initial="hidden" animate="visible" variants={containerContent} className="flex flex-col items-center lg:items-start gap-8 lg:w-full lg:gap-[34px]">
          <section className="flex flex-col gap-5 sm:items-center text-center lg:text-left lg:gap-6 lg:items-start">
            ...
            <p className="text-lg font-body text-black-300 sm:w-4/5 text-justify">
              A digital platform that collects, analyzes, and visualizes soil health data using sensors, GIS mapping, and analytics to enable precision farming and sustainable land management
            </p>
          </section>
        </motion.div>
        <motion.div
        ...
        >
          <div className="relative w-fit">
            ...
            <motion.div
              ...
              className="absolute top-[40%] -left-10 border-[0.5px] border-[#E2E2E2] rounded sales-card bg-white flex flex-col gap-2 font-body p-2 w-[96px] sm:w-[148px] sm:gap-3 sm:p-2.5 md:w-[196px] md:gap-4 md:border md:p-3.5"
            >
